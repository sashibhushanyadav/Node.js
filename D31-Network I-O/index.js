...
// -whenever possible, Libuv will use native async mechanism in the OS(operating system) 
//   so as to avoid blocking the main thread.

// NOTE: 
// -https.request is a network I/O (input/output) operation and not a CPU bound operation.
